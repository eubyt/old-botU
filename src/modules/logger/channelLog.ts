...
function LoggerChannelRegister(
    client: Client,
        ...
        embeds: [
            {
                ...
                fields: [
                    ...
                    },
                    {
                        name: "> Criado em",
                        value: `<t:${(
                            data.channel.createdTimestamp ?? 0
                        ).toFixed(0)}>`,
                    },
                ],
            },
        ...
        case "update":
            ...
            if (data.channel.time) {
                embed.embeds[0].fields.push({
                    name: "> Pinned at",
                    value: `<t:${(data.channel.time.getTime() / 1000).toFixed(
                        0
                    )}>`,
                });
            } else if (data.channel.name !== data.oldChannel.name) {
                embed.embeds[0].fields.push(
                    {
                        name: "Nome antigo",
            ...
            } else if (data.channel.type !== data.oldChannel.type) {
                embed.embeds[0].fields.push(
                    {
                        name: "Old Type",
                ...
                data.channel.category.id !== data.oldChannel.category.id
            ) {
                embed.embeds[0].fields.push(
                    {
                        name: "Old Category",
            ...
            } else if (data.channel.topic !== data.oldChannel.topic) {
                embed.embeds[0].fields.push(
                    {
                        name: "> Old Topic",
                ...
                data.channel.rateLimitPerUser !==
                data.oldChannel.rateLimitPerUser
            ) {
                embed.embeds[0].fields.push(
                    {
                        name: "Old Rate Limit",
            ...
            } else if (data.channel.nsfw !== data.oldChannel.nsfw) {
                embed.embeds[0].fields.push(
                    {
                        name: "Old NSFW",
            ...
            } else if (data.permissionsChange) {
