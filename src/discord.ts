...
client.once(Events.ClientReady, () => {
  ...
  // Register Ban Event
  registerEvent(new EventGuildBanAdd(client), LoggerBanRegister);
  registerEvent(new EventGuildBanRemove(client), LoggerBanRegister);
  registerEvent(new EventGuildMemberTimeout(client), LoggerBanRegister);
});
